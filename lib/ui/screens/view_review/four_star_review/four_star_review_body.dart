...
class FourStarReviewBody extends StatefulWidget {
  static Route route() =>
      MaterialPageRoute(builder: (_) => FourStarReviewBody());

  @override
  _FourStarReviewBody createState() => _FourStarReviewBody();
}

class _FourStarReviewBody extends State<FourStarReviewBody> {
  @override
          ...
          child: Column(
            children: [
              StreamBuilder<List<ReviewsModel>>(
                  stream: viewmodel.readFourStarsReviews(),
