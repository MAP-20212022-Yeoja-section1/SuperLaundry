...
class FourStarReviewDetailsBody extends StatefulWidget {
  final ReviewsModel post;

  FourStarReviewDetailsBody({required this.post});

  @override
  FourStarReviewDetailsBodyState createState() =>
      FourStarReviewDetailsBodyState();
}

class FourStarReviewDetailsBodyState extends State<FourStarReviewDetailsBody> {
  @override
                ...
                leading: IconButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => FourStarReviewScreen()));
                  },
