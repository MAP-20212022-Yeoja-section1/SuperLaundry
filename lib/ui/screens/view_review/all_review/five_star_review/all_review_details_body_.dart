...
class AllReviewDetailsBody extends StatefulWidget {
  final ReviewsModel post;

  AllReviewDetailsBody({required this.post});

  @override
  AllReviewDetailsBodyState createState() => AllReviewDetailsBodyState();
}

class AllReviewDetailsBodyState extends State<AllReviewDetailsBody> {
  @override
