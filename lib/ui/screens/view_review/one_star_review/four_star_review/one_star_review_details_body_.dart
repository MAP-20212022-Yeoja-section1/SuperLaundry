...
class OneStarReviewDetailsBody extends StatefulWidget {
  final ReviewsModel post;

  OneStarReviewDetailsBody({required this.post});

  @override
  OneStarReviewDetailsBodyState createState() =>
      OneStarReviewDetailsBodyState();
}

class OneStarReviewDetailsBodyState extends State<OneStarReviewDetailsBody> {
  @override
                ...
                leading: IconButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => OneStarReviewScreen()));
                  },
