...
class TwoStarReviewBody extends StatefulWidget {
  static Route route() =>
      MaterialPageRoute(builder: (_) => TwoStarReviewBody());

  @override
  _TwoStarReviewBody createState() => _TwoStarReviewBody();
}

class _TwoStarReviewBody extends State<TwoStarReviewBody> {
  @override
          ...
          child: Column(
            children: [
              StreamBuilder<List<ReviewsModel>>(
                  stream: viewmodel.readTwoStarsReviews(),
