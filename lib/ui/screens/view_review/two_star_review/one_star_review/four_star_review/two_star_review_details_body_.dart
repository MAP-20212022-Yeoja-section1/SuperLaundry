...
class TwoStarReviewDetailsBody extends StatefulWidget {
  final ReviewsModel post;

  TwoStarReviewDetailsBody({required this.post});

  @override
  TwoStarReviewDetailsBodyState createState() =>
      TwoStarReviewDetailsBodyState();
}

class TwoStarReviewDetailsBodyState extends State<TwoStarReviewDetailsBody> {
  @override
                ...
                leading: IconButton(
                  onPressed: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => TwoStarReviewScreen()));
                  },
